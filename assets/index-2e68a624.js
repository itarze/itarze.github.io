...
`,title$3="Keymap",component$3=e=>jsx(FontAwesomeIcon,{icon:faBook}),Encoder=styled(CenterPane)`
  height: 100%;
  background: var(--color_dark_grey);
`,Container$b=styled.div`
  ...
  flex-direction: column;
  padding: 0 12px;
`,Pane$7=()=>{const[e,t]=reactExports.useState(),[o,n]=reactExports.useState(),r=useAppSelector(getSelectedKey),s=useAppDispatch(),a=useAppSelector(getSelectedKeyDefinitions),i=useAppSelector(h=>getSelectedKeymap(h)||[]),c=useAppSelector(getSelectedLayerIndex);if(r===null||a[r]===void 0)return null;const l=i[r],d=a[r],u=d.col!==-1&&d.row!==-1,C=useAppSelector(getSelectedConnectedDevice),_=useAppSelector(getSelectedKeyboardAPI),K=(h,y)=>{if(_&&d.ei!==void 0){const g=+d.ei;switch(h){case"ccw":{_.setEncoderValue(c,g,!1,y),n(y);break}case"cw":{_.setEncoderValue(c,g,!0,y),t(y);break}case"click":{s(updateKey(r,y));break}}}},p=async(h,y,g)=>{const m=await g.getEncoderValue(h,y,!0),S=await g.getEncoderValue(h,y,!1);t(m),n(S)};return reactExports.useEffect(()=>{if(d!==void 0&&d.ei!==void 0&&_){const h=+d.ei;p(c,h,_)}},[d,C,c]),C&&C.protocol<10||o===void 0||e===void 0?null:jsx(OverflowCell,{children:jsx(Encoder,{children:jsxs(Container$b,{children:[jsxs(ControlRow,{children:[jsx(Label$1,{children:"Rotate Counterclockwise"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:o,meta:{},setValue:h=>K("ccw",h)})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:"Rotate Clockwise"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:e,meta:{},setValue:h=>K("cw",h)})})]}),u&&jsxs(ControlRow,{children:[jsx(Label$1,{children:"Press Encoder"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:l,meta:{},setValue:h=>K("click",h)})})]})]})})})},Message$1=styled.span`
  font-size: 18px;
  margin: 8px;
  text-align: center;
...
`,componentJoin=(e,t)=>e.reduce((o,n,r)=>(r&&o.push({...t,key:r}),o.push(n),o),[]),KeycodeMap=getKeycodes().flatMap(e=>e.keycodes).reduce((e,t)=>({...e,[t.code]:t}),{}),optimizeKeycodeSequence=e=>pipeline(e,convertCharacterTaps,trimLastWait,mergeConsecutiveWaits,foldKeydownKeyupKeys,convertToCharacterStreams),cleanKeycodeSequence=e=>pipeline(e,mergeConsecutiveWaits),MacroRecorder=({selectedMacro:e,setUnsavedMacro:t,saveMacro:o,undoMacro:n,isDelaySupported:r})=>{const[s,a]=reactExports.useState(!0),[i,c]=reactExports.useState(!1),[l,d]=reactExports.useState(!1),[u,C]=reactExports.useState(!!document.fullscreenElement),{smartOptimizeEnabled:_,recordDelaysEnabled:K}=useAppSelector(getMacroEditorSettings),p=useDispatch(),[h,y]=useKeycodeRecorder(i,K),g=reactExports.useRef(null),m=reactExports.useCallback(async R=>{c(R),R?(await navigator.keyboard.lock(),y([]),a(!1),d(!0)):(navigator.keyboard.unlock(),_&&y(optimizeKeycodeSequence(h)),d(!1))},[h,c]),S=reactExports.useCallback(()=>{o(""),a(!0),d(!1)},[y,o]),M=reactExports.useCallback(()=>{n(),y([]),a(!0),d(!1)},[n]);reactExports.useEffect(()=>{a(!0),d(!1),y([])},[e]);const f=()=>[...s?e??[]:h],A=reactExports.useMemo(()=>{let R,L=f();return s||!l||!_?R=L:R=optimizeKeycodeSequence(L),R},[h,s,_,l,e]);reactExports.useEffect(()=>{A&&t(sequenceToExpression(A))},[A]);const w=reactExports.useCallback(()=>{s&&a(!1)},[s]),O=reactExports.useCallback(R=>{const L=f();L.splice(R,1),y(cleanKeycodeSequence(L)),w()},[A,e,h,s]),v=reactExports.useCallback((R,L)=>{const b=f();b.splice(R,1,[RawKeycodeSequenceAction.Delay,L]),y(cleanKeycodeSequence(b)),w()},[A,e,h,s]),P=reactExports.useMemo(()=>componentJoin(A.map(([R,L],b)=>{const I=getSequenceItemComponent(R);return jsx(Deletable,{index:b,deleteItem:O,disabled:i,children:RawKeycodeSequenceAction.Delay!==R?jsx(I,{children:R===RawKeycodeSequenceAction.CharacterStream?componentJoin(String(L).split(" ").map((N,F)=>jsx("span",{children:N},F)),jsx("span",{style:{fontFamily:"fantasy, cursive, monospace"},children:"␣"})):Array.isArray(L)?L.map(N=>getSequenceLabel(KeycodeMap[N])??N).join(" + "):getSequenceLabel(KeycodeMap[L])}):jsx(WaitInput,{index:b,value:Number(L),updateValue:v})},`${b}-${R}`)}),jsx(SequenceLabelSeparator,{})),[A]);reactExports.useEffect(()=>{const R=()=>{C(!!document.fullscreenElement)};return document.documentElement.addEventListener("fullscreenchange",R),()=>{m(!1),document.documentElement.removeEventListener("fullscreenchange",R)}},[C]);const T=reactExports.useCallback(()=>{document.fullscreenElement?document.exitFullscreen&&(m(!1),document.exitFullscreen()):document.documentElement.requestFullscreen()},[m]);return jsxs(Fragment,{children:[jsx(MacroSequenceContainer,{ref:g,$isModified:!s,children:P.length?P:jsx(NoMacroRecorded,{children:"No macro recorded yet..."})}),jsx("div",{style:{border:"none",maxWidth:960,width:"100%",display:"flex",justifyContent:"center",transform:"translate(-0px, -21px)"},children:jsx(MacroEditControls,{isFullscreen:u,isEmpty:!e||!e.length,optimizeRecording:_,recordDelays:K,isRecording:i,addText:()=>{},deleteMacro:S,toggleOptimizeRecording:()=>{p(setMacroEditorSettings({smartOptimizeEnabled:!_}))},toggleRecordDelays:()=>{p(setMacroEditorSettings({recordDelaysEnabled:!K}))},toggleFullscreen:T,undoChanges:M,saveChanges:()=>o(),hasUnsavedChanges:!s,recordingToggleChange:m,isDelaySupported:r})})]})},TextArea=styled.textarea`
  box-sizing: border-box;
  background: var(--bg_control);
  padding: 5px 10px;
...
`,UsbErrorWebHIDLink=styled.a`
  text-decoration: underline;
  color: var(--color_label-highlighted);
`,timeoutRepeater=(e,t,o=0)=>()=>setTimeout(()=>{e(),o>0&&timeoutRepeater(e,t,o-1)()},t),Home=e=>{const{hasHIDSupport:t}=e,o=useAppDispatch(),n=useAppSelector(getAllowKeyboardKeyRemapping),r=useAppSelector(getSelectedKey),s=useAppSelector(getSelectedDefinition),a=useAppSelector(getConnectedDevices),i=useAppSelector(getSelectedLayerIndex),c=useAppSelector(getSelectedKeyDefinitions),l=useAppSelector(getDisableFastRemap),{basicKeyToByte:d}=useAppSelector(getBasicKeyToByte),u=useAppSelector(getSelectedKeyboardAPI),C=timeoutRepeater(()=>{o(reloadConnectedDevices())},500,1),_=async m=>{i!==null&&r!==null&&s&&(o(updateKey(r,m)),o(updateSelectedKey(l?null:getNextKey(r,c))))},K=m=>{if(n&&r!==null){const S=mapEvtToKeycode(m);S&&_(getByteForCode(S,d))}},p=()=>{const m=document.body;m&&m.addEventListener("keydown",K)},h=()=>{const m=document.body;m&&m.removeEventListener("keydown",K)},y=async()=>{if(!u||!s)return;const m=200;if(dist.isVIADefinitionV2(s)&&dist.getLightingDefinition(s.lighting).supportedLightingValues.includes(dist.LightingValue.BACKLIGHT_EFFECT)){const S=await u.getRGBMode(),M=S!==0?0:1;for(let f=0;f<3;f++)u.timeout(f===0?0:m),u.setRGBMode(M),u.timeout(m),await u.setRGBMode(S)}if(dist.isVIADefinitionV3(s))for(let S=0;S<6;S++)u.timeout(S===0?0:m),await u.setKeyboardValue(KeyboardValue.DEVICE_INDICATION,S)},g=reactExports.createRef();return reactExports.useEffect(()=>{if(t)return g.current&&g.current.focus(),startMonitoring(),usbDetect.on("change",C),o(loadSupportedIds()),p(),()=>{usbDetect.off("change",C),h()}},[]),reactExports.useEffect(()=>{o(updateSelectedKey(null)),Object.values(a).length>1&&y()},[u]),!t&&!OVERRIDE_HID_CHECK?jsx(ErrorHome,{ref:g,tabIndex:0,children:jsxs(UsbError,{children:[jsx(UsbErrorIcon,{children:"❌"}),jsx(UsbErrorHeading,{children:"USB Detection Error"}),jsxs("p",{children:["Looks like there was a problem getting USB detection working. Right now, we only support"," ",jsx(UsbErrorWebHIDLink,{href:"https://caniuse.com/?search=webhid",target:"_blank",children:"browsers that have WebHID enabled"}),", so make sure yours is compatible before trying again."]})]})}):jsx(Fragment,{children:e.children})},useSize=e=>{const[t,o]=reactExports.useState();return reactExports.useLayoutEffect(()=>{e.current&&o(e.current.getBoundingClientRect())},[e]),useResizeObserver(e,n=>o(n.contentRect)),t},ZOOM=5.5*.8,Camera=()=>{const{progress:e}=useProgress(),t=useThree(s=>s.camera),[o,n]=[7,7],r=J({config:{duration:800},from:{x:o}});return React.useEffect(()=>{e===100&&(console.debug("lets animate"),r.x.start(n))},[e]),React.useEffect(()=>(console.debug("mounting"),()=>{console.debug("unmounting")}),[]),useFrame(()=>{r.x.isAnimating&&(t.position.setZ(r.x.get()),t.position.setY(.4*Math.pow(r.x.get()-n,1)),t.updateProjectionMatrix()),t.zoom!==ZOOM&&(t.zoom=ZOOM,t.updateProjectionMatrix())}),jsx(PerspectiveCamera,{"position-z":o,makeDefault:!0,fov:25})},CaseGroup=styled.div``,OuterCase=styled.div`
...
`,EncoderKey=e=>jsx(EncoderKeyContainer,{onClick:e.onClick,style:e.style,children:jsx(EncoderKeyContent2,{$size:e.size&&+e.size,$innerPadding:5*e.size/52})}),getMacroData$1=({macroExpression:e,label:t})=>t&&t.length>15?t:e&&e.length?e:null,paintKeycapLabel$1=(e,t,o)=>{const n=e.getContext("2d");if(n==null)return;const r=devicePixelRatio,[s,a]=[e.width,e.height];e.width=s*r,e.height=a*r,e.style.width=`${s}px`,e.style.height=`${a}px`,n.scale(r,r);const i="Fira Sans, Arial Rounded MT, Arial Rounded MT Bold, Arial",c={x:4,y:4},l={x:4,y:4},d={x:3,y:0},u={x:4,y:4};if(n.beginPath(),n.moveTo(0,0),n.lineTo(e.width,0),n.lineTo(e.width,e.height),n.lineTo(0,e.height),n.lineTo(0,0),n.clip(),n.fillStyle=t,o!==void 0){if(o.topLabel&&o.bottomLabel){let C=16,_=.75*C,K=o.offset[0]*_,p=o.offset[1]*_;n.font=`bold ${C}px ${i}`,n.fillText(o.topLabel,c.x,c.y+K+_),n.fillText(o.bottomLabel,l.x,a-l.y-p)}else if(o.centerLabel){let C=13*o.size,_=.75*C,K=a/2;return n.font=`bold ${C}px ${i}`,n.fillText(o.label,d.x,K+.5*_),n.measureText(o.centerLabel).width>s-d.x}else if(typeof o.label=="string"){let C=22,_=.75*C;n.font=`bold ${C}px ${i}`,n.fillText(o.label,u.x,u.y+_)}}},paintKeycap$1=(e,t,o,n,r)=>{const[s,a]=[CSSVarObject.keyWidth,CSSVarObject.keyHeight];if(e.width=s*t-CSSVarObject.faceXPadding.reduce((c,l)=>c+l,0),e.height=a*o-CSSVarObject.faceYPadding.reduce((c,l)=>c+l,0),e.getContext("2d")!=null)return paintKeycapLabel$1(e,n,r)},Keycap$1=React.memo(e=>{const{label:t,scale:o,color:n,selected:r,disabled:s,mode:a,rotation:i,keyState:c,shouldRotate:l,textureWidth:d,textureHeight:u,idx:C}=e,_=t&&getMacroData$1(t),[K,p]=reactExports.useState(!1),[h,y]=reactExports.useState(!1),g=reactExports.useRef(null),m=React.useCallback(()=>{if(g.current&&n&&t&&document.fonts.check('bold 16px "Fira Sans"',t.label)){const b=paintKeycap$1(g.current,d,u,n.t,t);p(!!b)}},[g.current,d,t&&t.key,o[0],o[1],n&&n.t,n&&n.c,l]);reactExports.useEffect(m,[t&&t.key,n&&n.c,n&&n.t]),reactExports.useEffect(()=>(document.fonts.addEventListener("loadingdone",m),()=>{document.fonts.removeEventListener("loadingdone",m)}),[]);const[S,M]=[-8,0],f=DisplayMode.Test===a?TestKeyState.KeyDown===c?KeycapState.Pressed:KeycapState.Unpressed:h||r?KeycapState.Pressed:KeycapState.Unpressed,[A]=f===KeycapState.Pressed?[S,i[2]]:[M,i[2]+Math.PI*Number(l)],w=c===TestKeyState.KeyUp,O=DisplayMode.Test===a?f===KeycapState.Unpressed?w?"mediumvioletred":"lightgrey":"mediumvioletred":(f===KeycapState.Unpressed,"lightgrey"),v=f===KeycapState.Unpressed?w?.4:0:.6,[P,T,R,L]=reactExports.useMemo(()=>{const b=()=>{};return s?[b,b,b,b]:e.mode===DisplayMode.ConfigureColors?[b,I=>{e.onPointerOver&&e.onPointerOver(I,C)},b,I=>{e.onPointerDown&&e.onPointerDown(I,C)}]:[I=>e.onClick(I,C),I=>{e.onPointerOver&&e.onPointerOver(I,C),y(!0)},()=>y(!1),I=>{e.onPointerDown&&e.onPointerDown(I,C)}]},[s,e.onClick,e.onPointerDown,e.onPointerOver,y,C,a]);return l?jsx(EncoderKey,{onClick:P,size:d*CSSVarObject.keyWidth,style:{transform:`translate(${e.position[0]-(CSSVarObject.keyWidth*d-CSSVarObject.keyWidth)/2}px,${d*(CSSVarObject.keyHeight-CSSVarObject.keyWidth)/2+e.position[1]-(CSSVarObject.keyHeight*u-CSSVarObject.keyHeight)/2}px) rotate(${-e.rotation[2]}rad)`,borderRadius:3,color:e.color.c}}):e.clipPath?jsx(ComboKeycap,{...e,onClick:P,onPointerDown:L,onPointerOver:T,onPointerOut:R,keycapZ:A,keycapOpacity:v,keycapColor:O,canvasRef:g,macroData:_,overflowsTexture:K,style:{transform:`translate(${CSSVarObject.keyWidth/2+e.position[0]-(CSSVarObject.keyXPos*d-CSSVarObject.keyXSpacing)/2}px,${CSSVarObject.keyHeight/2+e.position[1]-(CSSVarObject.keyYPos*u-CSSVarObject.keyYSpacing)/2}px) rotate(${-e.rotation[2]}rad)`,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing}}):jsx(Fragment,{children:jsxs(KeycapContainer,{onClick:P,onPointerDown:L,onPointerOver:T,onPointerOut:R,style:{transform:`translate(${CSSVarObject.keyWidth/2+e.position[0]-(CSSVarObject.keyXPos*d-CSSVarObject.keyXSpacing)/2}px,${CSSVarObject.keyHeight/2+e.position[1]-(CSSVarObject.keyYPos*u-CSSVarObject.keyYSpacing)/2}px) rotate(${-e.rotation[2]}rad)`,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing,cursor:s?"initial":"pointer"},children:[jsxs(GlowContainer,{$selected:r,style:{animation:s?"initial":r?".75s infinite alternate select-glow":"",background:getDarkenedColor(e.color.c,.8),transform:`perspective(100px) translateZ(${A}px)`,borderRadius:3,width:d*CSSVarObject.keyXPos-CSSVarObject.keyXSpacing,height:u*CSSVarObject.keyYPos-CSSVarObject.keyYSpacing},children:[DisplayMode.Test===a?jsx(TestOverlay,{style:{background:O,opacity:v}}):null,jsx(CanvasContainer,{style:{borderRadius:4,background:e.color.c,height:"100%"},children:jsx("canvas",{ref:g,style:{}})})]}),(_||K)&&jsx(TooltipContainer,{$rotate:i[2],children:jsx(Keycap2DTooltip,{children:_||t&&t.tooltipLabel})})]})})},shallowEqual),GlowContainer=styled.div`
  box-sizing: border-box;
  padding: 2px 6px 10px 6px;
  transition: transform 0.2s ease-out;
  box-shadow: inset -1px -1px 0 rgb(0 0 0 / 20%),
...
`;function getKeycapSharedProps(e,t,o,n,r,s){const{position:a,rotation:i,scale:c,color:l,idx:d,onClick:u,onPointerDown:C,onPointerOver:_}=n.coords[t],K=e.ei!==void 0;return{mode:o.mode,position:a,rotation:i,scale:getScale(e,c),textureWidth:e.w,textureHeight:e.h,textureOffsetX:e.w2?Math.abs(e.w2-e.w):0,color:l,shouldRotate:K,onPointerDown:C,onPointerOver:_,keyState:o.pressedKeys?o.pressedKeys[t]:-1,disabled:!o.selectable,selected:t===r,idx:d,label:s[t],onClick:u}}const getKeysKeysIndices=e=>(t,o)=>{const n=t.ei!==void 0;return`${e}-${o}-${t.w}-${t.h}-${n}`};function getLabels(e,t,o,n){return e.matrixKeycodes.length?e.keys.map((r,s)=>getLabel(e.matrixKeycodes[s],r.w,t,e.definition,o,n)):[]}function getKeysKeys(e,t,o,n){const{keys:r}=e,{rowMap:s}=getKeyboardRowPartitions(r);return{indices:r.map(getKeysKeysIndices(e.definition.vendorProductId)),coords:r.map((a,i)=>{const[c,l]=calculatePointPosition(a),d=a.r*(2*Math.PI)/360,u=KeycapMetric.keyXSpacing/KeycapMetric.keyWidth,C=KeycapMetric.keyYSpacing/KeycapMetric.keyHeight,_=(1+u)*(a.w2||a.w)-u,K=a.h*(1+C)-C,p=getMeshName(a,s[getKeyId(a)],!1),h=e.keyColors?i:a.color,y=t[h];return{position:n(c,l),rotation:[0,0,-d],scale:[_,K,1],color:y,meshKey:p,idx:i,onClick:(g,m)=>{g.stopPropagation(),o(updateSelectedKey(m))},onPointerDown:e.onKeycapPointerDown,onPointerOver:e.onKeycapPointerOver}})}}const KeyGroupContainer=styled.div`
  position: absolute;
  top: ${e=>CaseInsideBorder*1.5}px;
  left: ${e=>CaseInsideBorder*1.5}px;
`,getPosition$1=(e,t)=>[e-CSSVarObject.keyWidth/2,t-CSSVarObject.keyHeight/2,0],getRGBArray=e=>e.map(([t,o])=>{const n=getRGB({hue:Math.round(255*t/360),sat:Math.round(255*o)}),r=`#${new Color(n).getHexString()}`;return{c:r,t:r}}),KeyGroup$1=e=>{const t=useAppDispatch(),o=useAppSelector(getSelectedKey),n=useAppSelector(getSelectedTheme),r=useAppSelector(getExpressions),s=e.keyColors?getRGBArray(e.keyColors):n,{basicKeyToByte:a,byteToKey:i}=useAppSelector(getBasicKeyToByte),c=useAppSelector(y=>y.macros),{keys:l,selectedKey:d}=e,u=d===void 0?o:d,C=reactExports.useMemo(()=>getKeysKeys(e,s,t,getPosition$1),[l,s,e.onKeycapPointerDown,e.onKeycapPointerOver]),_=reactExports.useMemo(()=>getLabels(e,r,a,i),[l,e.matrixKeycodes,c,e.definition]),{width:K,height:p}=calculateKeyboardFrameDimensions(l),h=reactExports.useMemo(()=>e.keys.map((y,g)=>jsx(Keycap$1,{...getComboKeyProps(y),...getKeycapSharedProps(y,g,e,C,u,_)},g)),[l,u,_,e.pressedKeys,e.selectable,s,e.definition.vendorProductId]);return jsx(KeyGroupContainer,{height:p,width:K,style:{pointerEvents:e.selectable?"all":"none"},children:h})},generateRowColArray=(e,t,o)=>{const n=e.filter(a=>a.ei===void 0),r=n.reduce((a,i)=>(a[i.row][i.col]=calculatePointPosition(i),a),Array(t).fill(0).map(()=>Array(o).fill(0))).map(a=>a.sort((i,c)=>i[0]-c[0])),s=n.reduce((a,i)=>(a[i.col][i.row]=calculatePointPosition(i),a),Array(o).fill(0).map(()=>Array(t).fill(0))).map(a=>a.sort((i,c)=>i[1]-c[1]));return{rowKeys:r,colKeys:s}},Matrix=({rowKeys:e,colKeys:t})=>jsxs(SVG,{style:{position:"absolute",top:0},children:[e.map((o,n)=>jsx(RowLine,{points:o.map(r=>(r||[]).join(",")).join(" ")},n)),t.map((o,n)=>jsx(ColLine,{points:o.map(r=>(r||[]).join(",")).join(" ")},n))]}),SVG=styled.svg`
  transform: rotateZ(0);
  width: 100%;
  height: 100%;
