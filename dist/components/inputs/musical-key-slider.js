...
export function MusicalKeySlider(props) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(AccentSlider, {
    ...props,
    isChecked: false,
    onChange: (arg) => arg ? window.addEventListener("keydown", keyHandler) : window.removeEventListener("keydown", keyHandler)
  }));
}
