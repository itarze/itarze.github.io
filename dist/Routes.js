...
export default () => {
  ...
  return /* @__PURE__ */ React.createElement(Router, null, hasHIDSupport && /* @__PURE__ */ React.createElement(UnconnectedGlobalMenu, null), /* @__PURE__ */ React.createElement(Home, {
    hasHIDSupport
