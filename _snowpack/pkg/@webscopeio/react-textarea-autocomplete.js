...
var customEvent = useNative() ? NativeCustomEvent : typeof document !== "undefined" && typeof document.createEvent === "function" ? function CustomEvent(type, params) {
  ...
  function ReactTextareaAutocomplete2(_props) {
    ...
    _this2._changeHandler = function(e) {
      ...
      var setTopLeft = function setTopLeft2() {
        var _getCaretCoordinates = textareaCaret(textarea, selectionEnd), newTop = _getCaretCoordinates.top, newLeft = _getCaretCoordinates.left;
        _this2.setState({
